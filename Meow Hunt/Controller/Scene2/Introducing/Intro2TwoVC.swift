...
class Intro2TwoVC: UIViewController {
    ...
    var viewTable: UIImageView = {
        ...
        img.image = UIImage(named: "table2_intro2")
        img.contentMode = .scaleAspectFill
    ...
    var viewCat: UIImageView = {
        ...
        img.image = UIImage(named: "cat2_intro2")
        img.contentMode = .scaleAspectFill
    ...
    var textIntroStorytelling: UILabel = {
        ...
        label.text = "Waduh! Aku tidak sengaja menjatuhkan air di atas meja.\n\n Ayo bantu aku mengelap meja terlebih dahulu sebelum buku di atasnya basah!"
...
//        10 sec
        playAir()
        textIntroStorytelling.setTypingIntroduction(text: "Waduh! Aku tidak sengaja menjatuhkan air di atas meja.Ayo bantu aku mengelap meja terlebih dahulu sebelum buku di atasnya basah!", characterDelay: 10)
    ...
    @objc func goToWipeTutorial(sender: UITapGestureRecognizer){
        ...
        navigationController?.pushViewController(TutorController(), animated: false)
    }
    ...
    @objc func playAir(){
        self.playSound(file: "scene air 1", fileExtension: "mp3")
    }
